...
include_once('../mail-membership.php');

//include_once('../membership_insert.php');
...
$callback_url = 'http://www.aakenya.com/redirect.php'; //redirect url, the page that will handle the response from pesapal.
